...
import { BookOpen, Calendar, Clock, DollarSign, Plus, Trash2, User, Phone, GraduationCap, Layers } from "lucide-react";
        ...
        <div className="p-8 sm:p-10 max-w-7xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 bg-white/5 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/10 shadow-2xl h-fit">
                    ...
                    <form onSubmit={handleCreateClass} className="space-y-4">
                        ...
                        <div className="space-y-3 bg-black/20 p-4 rounded-2xl border border-white/5">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="text-[10.5px] text-blue-400 hover:text-blue-300 font-bold underline transition"
                                >
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="w-full mt-3 bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-xl shadow-lg transition text-xs uppercase tracking-wider flex items-center justify-center gap-2"
                        >
                ...
                <div className="lg:col-span-7 space-y-4">
                    ...
                    {loading ? (
                        <div className="p-12 text-center text-slate-400 font-medium">Loading scheduled classes...</div>
                    ) : classes.length === 0 ? (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4 self-end sm:self-center">
                                        ...
                                        <button
                                            ...
                                            className="p-2.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 transition"
                                            title="Delete Class"
                                        >
                                            <Trash2 size={16} />
                                        </button>
